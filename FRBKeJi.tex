...
\begin{spacing}{3}
    \erhao
    \begin{center}
        \zhongsong\erhao{第二十九届“冯如杯”学生学术科技作品竞赛论文} %黑体这样调用，其余字体同理

        \zhongsong{本模板由北航计算机学院Someday开发}
        
        \zhongsong{本模板供所有用户免费使用，勿做商用}
    \end{center}
\end{spacing}
%格式控制部分
\par \ 
...
%********************正文页眉部分********************
%\lhead{} 
\chead{\xiaowu 本模板系北航计算机学院Someday所开发，供个人用户免费使用，勿做商用} %设置居中页眉
%********************正文页眉部分********************
